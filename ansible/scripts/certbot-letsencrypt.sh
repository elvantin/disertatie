...
echo ""
warn "IMPORTANT: Certificatul este acum de incredere — SSL Labs va arata Grade A."
warn "  Pentru Grade A+ (HSTS, TLS 1.2+1.3, cifruri puternice), ruleaza hardening-ul:"
warn "    ansible-playbook playbooks/4-harden-nginx-ssl_ssllabs.com_ssltest.yml"
echo ""
