...
$VaultName = "rsv-mediasrl-productie" #fetch automatically
$Subscription = "Valentin - Microsoft Azure Sposorship" #fetch automatically
$ResourceGroup = "rg-mediasrl-productie-swedencentral" #fetch automatically
$SubscriptionId = "7a0255bf-d664-4920-afb0-c523b49c1908" #fetch automatically
